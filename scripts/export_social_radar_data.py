...
STRATEGIC_FOCUS_SEEDS = [
    ...
    },
    {
        ...
        "project_examples": [
            ...
            {
                "title": "竞品平台观察池",
                "platform": "DramaBox / ShortMax / GoodShort / My Drama / PocketFilms",
                "date_window": "持续观察",
                "audience_segment": "泛向/待验证",
                "topic_tag": "非 ReelShort 平台，优先补男频/AI漫剧项目",
                "evidence": "公开网页可确认平台存在，但热榜项目需合规榜单或人工录入",
            },
        ],
