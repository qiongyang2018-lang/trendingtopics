...
STRATEGIC_FOCUS_SEEDS = [
    {
        ...
        "candidate_projects": "AI仿真人地域爽剧；AI漫剧IP工业化；2D男频升级漫剧；西幻AI新剧；诡异怪谈漫剧",
        "project_examples": [
            {
                "title": "AI仿真人地域爽剧",
                "platform": "AI仿真人 / 地域爽剧",
                ...
                "evidence": "适合用AI仿真人测试强身份反转和低成本情绪爽点",
            },
            {
                "title": "AI漫剧IP工业化",
                "platform": "ToonScroll / PineDrama / TikTok minis",
                "date_window": "36氪公开报道AI短剧出海平台动作",
                "audience_segment": "混合/待验证",
                "topic_tag": "网文IP、批量生成、竖屏漫剧、平台化生产",
                "evidence": "适合追踪高概念题材的低成本批量测试能力",
            },
            {
                "title": "2D男频升级漫剧",
                "platform": "DataEye / 漫剧有数题材信号",
    ...
    },
    {
        ...
        "candidate_projects": "体育复出爽剧；失落继承人/家族复仇；赘婿反杀/强者回归；西幻升级/龙与王者；诡异怪谈/末世副本",
        "project_examples": [
            {
                "title": "体育复出爽剧",
                "platform": "竞品样本方向",
