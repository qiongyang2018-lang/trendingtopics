...
STRATEGIC_FOCUS_SEEDS = [
    {
        ...
        "candidate_projects": "DataEye海外微短剧热榜：西幻AI新剧（2026-03-27，已超2个月，仅作旧基准）；DataEye短剧&漫剧日榜：AI仿真人剧/萌宝漫剧集中上榜（2026-03-30，旧基准）；36氪：ToonScroll、PineDrama、TikTok minis 等AI短剧出海动作（2026-06-03，近2个月）；Peacock/ReelShort授权 micro drama（2026-05-13，近2个月，主流平台试水，不作竞品榜单）",
        "project_examples": [
            {
                "title": "ToonScroll / PineDrama / TikTok minis",
                "platform": "AI短剧/漫剧平台动作",
                "date_window": "2026-06-03",
                "audience_segment": "混合/待验证",
                "topic_tag": "AI短剧出海 / IP+AI工业化",
                "evidence": "36氪公开报道，近2个月",
            },
            {
                "title": "AI仿真人剧、萌宝漫剧集中上榜",
                "platform": "DataEye短剧&漫剧日榜",
                "date_window": "2026-03-30",
                "audience_segment": "女频",
                "topic_tag": "AI仿真人 / 萌宝 / 经典高转化题材",
                "evidence": "旧基准，需用小程序/榜单复核近2个月项目名",
            },
            {
                "title": "西幻AI新剧",
                "platform": "DataEye海外微短剧热榜",
                "date_window": "2026-03-27",
                "audience_segment": "混合/待验证",
                "topic_tag": "西幻 / AI新剧 / 投放素材增长",
                "evidence": "旧基准，已超2个月，仅保留为方向参照",
            },
            {
                "title": "Peacock 引入 ReelShort micro dramas",
                "platform": "Peacock / ReelShort授权",
                "date_window": "2026-05-13",
                "audience_segment": "泛向/待验证",
                "topic_tag": "主流流媒体试水竖屏短剧",
                "evidence": "Business Insider公开报道，近2个月；不是竞品榜单",
            },
        ],
    ...
    },
    {
        ...
        "candidate_projects": "A Deal with the Hockey Captain（DramaBox，体育男主/契约关系，公开报道样本，需复核近2个月榜单）；The Lost Heir: A Christmas Reckoning（DramaBox，失落继承人/家族复仇，公开报道样本，需复核近2个月榜单）；My Secret Agent Husband（PocketFilms/报道样本，秘密特工/假订婚，2026早期样本）；Fox x Dhar Mann vertical microdrama slate（My Drama/Holywater，2026-01公布，非单剧名但代表非亚洲平台加码）；Ace! The Golf King's Reconquest（微短剧样本，高尔夫王者归来，需人工确认平台和近期热度）",
        "project_examples": [
            {
                "title": "A Deal with the Hockey Captain",
                "platform": "DramaBox",
                "date_window": "公开报道样本，需复核近2个月榜单",
                "audience_segment": "混合/待验证",
                "topic_tag": "体育男主 / 契约关系 / 校园或职业竞技",
                "evidence": "Business Insider提及；非实时榜单",
            },
            {
                ...
                "date_window": "公开报道样本，需复核近2个月榜单",
                "audience_segment": "男频",
                "topic_tag": "失落继承人 / 家族复仇 / 身份反转",
                "evidence": "Business Insider提及；非实时榜单",
            },
            {
                "title": "My Secret Agent Husband",
                "platform": "PocketFilms",
                "date_window": "2026早期样本，需复核近2个月热度",
                "audience_segment": "混合/待验证",
                "topic_tag": "秘密特工 / 假订婚 / 高概念男主",
                "evidence": "The Sun报道样本；非实时榜单",
            },
            {
                "title": "Fox x Dhar Mann vertical microdrama slate",
                "platform": "My Drama / Holywater",
                "date_window": "2026-01公布，平台动作",
                "audience_segment": "泛向/待验证",
                "topic_tag": "非亚洲平台加码 / 情绪故事 / 批量原创",
                "evidence": "公开行业报道；不是单剧榜单",
            },
            {
                "title": "Ace! The Golf King's Reconquest",
                "platform": "待确认",
                "date_window": "需人工确认近期热度",
                "audience_segment": "男频",
                "topic_tag": "体育复出 / 父女 / 荣誉夺回",
                "evidence": "用户提供样本；待榜单复核",
            },
        ],
